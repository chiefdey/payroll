...
function calc_payee(tax) {
    ...
    if (tax >= 0 && tax <= 24000) {
        ...
        payee = (24000 * 0.01) + (8333 * 0.25) + ((tax - 24000) * 0.3) - relief
    } else if (tax > 500000 && tax <= 800000) {
        payee = (24000 * 0.01) + (8333 * 0.25) + (467667 * 0.3) + ((tax - 24000) * 0.325) - relief
    } else if (tax > 800000 && tax <= 800000) {
        payee = (24000 * 0.01) + (8333 * 0.25) + (467667 * 0.3) + (300000 * 0.325) + ((tax - 24000) * 0.35) - relief
    } return payee
}
